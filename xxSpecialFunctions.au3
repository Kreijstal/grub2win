...
Func SpecFuncGUICtrlGetBkColor($hWnd)
...
Func SpecFuncGUICtrlPicCreate ($gpcimagepath, $iLeft, $iTop, $iWidth = -1, $iHeight = -1, $iStyle = -1, $iExStyle = -1)
	$gpchandle = GUICtrlCreatePic        ("", $iLeft, $iTop, $iWidth,      $iHeight,      $iStyle,      $iExStyle)
	SpecFuncGUICtrlSetImage ($gpchandle, $gpcimagepath, $iWidth, $iHeight)
	Return $gpchandle
EndFunc

; PNG Workaround by UEZ
Func SpecFuncGUICtrlSetImage ($gsihandle, $gsiimagepath, $gsiwidth = -1, $gsiheight = -1)
	_GDIPlus_Startup()
	Local $hBitmap = _GDIPlus_BitmapCreateFromFile($gsiimagepath)
	If $gsiwidth  = -1 Then $gsiwidth  = _GDIPlus_ImageGetWidth  ($hBitmap)
    If $gsiheight = -1 Then $gsiheight = _GDIPlus_ImageGetHeight ($hBitmap)
    Local $hBitmap_Resized = _GDIPlus_BitmapCreateFromScan0  ($gsiwidth, $gsiheight)
	...
	_GDIPlus_GraphicsFillRect($hBMP_Ctxt, 0, 0, $gsiwidth, $gsiheight, 0)          ; Black background
    _GDIPlus_GraphicsDrawImageRect ($hBMP_Ctxt, $hBitmap, 0, 0, $gsiwidth, $gsiheight)
    Local $hHBitmap = _GDIPlus_BitmapCreateDIBFromBitmap($hBitmap_Resized)
	Local $hPrevImage = GUICtrlSendMsg($gsihandle, $STM_SETIMAGE, 0, $hHBitmap) ; $STM_SETIMAGE = 0x0172
...
Func SpecFunc_GDIPlus_GraphicsDrawImageTrans($hGraphics, $hImage, $diwidth, $diheight, $dileft, $ditop, $nTrans = 0.66)
	...
	_GDIPlus_GraphicsDrawImageRectRect($hGraphics, $hImage, 0, 0, $iW, $iH, $dileft, $ditop, $diwidth, $diheight, $hImgAttrib)
    _GDIPlus_ImageAttributesDispose($hImgAttrib)
    Return
EndFunc

Func SpecFunc_ImageColorRegExpReplace($hImage, $iColSrch, $iColNew, $iCount = 0)
	; Note colour format hex 0xBBGGRRAA - Blue, Green, Red, Alpha (transparency)
	; $hImage2 = _ImageColorRegExpReplace($hImage, "(000000FF)" , "00FFFFFF" ); Change black to yellow
...
;                                   [n][5] = Client area height
;                                   [n][6] = Horizontal max setting
...
; Example........; Yes
;=====================================================================================================================
Func SpecFunc_GUIScrollbars_Generate($hWnd, $iH_Scroll = 0, $iV_Scroll = 0, $iH_Tight = 0, $iV_Tight = 0, $fBefore = False, $iRepeat = 0, $bRegisterMsg = True)
	...
	If $iH_Scroll Then
		...
		If $bRegisterMsg Then
			GUIRegisterMsg($WM_HSCROLL, "SpecFunc_Scrollbars_WM_HSCROLL")
			GUIRegisterMsg($WM_MOUSEHWHEEL, 'SpecFunc_Scrollbars_WM_MOUSEHWHEEL')
		EndIf
	EndIf
	If $iV_Scroll Then
		_GUIScrollBars_ShowScrollBar($hWnd, $SB_VERT)
		If $bRegisterMsg Then
			GUIRegisterMsg($WM_VSCROLL, "SpecFunc_Scrollbars_WM_VSCROLL")
			GUIRegisterMsg($WM_MOUSEWHEEL, "SpecFunc_Scrollbars_WM_MOUSEWHEEL")
		EndIf
	EndIf
	; Only register for key scrolling if required
	If $iRepeat And $bRegisterMsg Then
		GUIRegisterMsg($WM_KEYUP, "SpecFunc_Scrollbars_WM_KEYUP")
	EndIf
...
;                            2 - GUI not initiated
;                            3 - GUI not resizable
; Remarks .......; - Resizable GUIs have slightly smaller client areas than defined in GUI-Create because of their
...
; Example........; Yes
;=====================================================================================================================
Func SpecFunc_GUIScrollbars_ReSizer($hWnd, $iH_Max, $iV_Max, $bFullClient = False, $bRegisterMsg = True)
	...
	If Not $bFullClient Then
		...
		SpecFunc_Scrollbars_WM_EXITSIZEMOVE($hWnd, 0, 0, 0)
	EndIf

	; Register mesaage handlers if required
	If $bRegisterMsg Then
		GUIRegisterMsg($WM_EXITSIZEMOVE, "SpecFunc_Scrollbars_WM_EXITSIZEMOVE")
		GUIRegisterMsg($WM_ENTERSIZEMOVE, "SpecFunc_Scrollbars_WM_ENTERSIZEMOVE")
	EndIf
...
; Example........; Yes
;=====================================================================================================================
Func SpecFunc_GUIScrollbars_Locate_Ctrl($hWnd, $iX, $iY)
...
; Example........; Yes
;=====================================================================================================================
Func SpecFunc_GUIScrollbars_Scroll_Page($hWnd, $iH_Scroll_Pos = 0, $iV_Scroll_Pos = 0)
...
; Example........; Yes
;=====================================================================================================================
Func SpecFunc_GUIScrollbars_Minimize($hWnd)
...
; Example........; Yes
;=====================================================================================================================
Func SpecFunc_GUIScrollbars_Restore($hWnd, $fVert = True, $fHorz = True)
...
; Remarks .......:
; ===============================================================================================================================
Func SpecFunc_Scrollbars_WM_VSCROLL($hWnd, $iMsg, $wParam, $lParam)
...
; Remarks .......:
; ===============================================================================================================================
Func SpecFunc_Scrollbars_WM_HSCROLL($hWnd, $iMsg, $wParam, $lParam)
...
; ===============================================================================================================================
Func SpecFunc_Scrollbars_WM_MOUSEWHEEL($hWnd, $iMsg, $wParam, $lParam)
...
; ===============================================================================================================================
Func SpecFunc_Scrollbars_WM_MOUSEHWHEEL($hWnd, $iMsg, $wParam, $lParam)
...
; ===============================================================================================================================
Func SpecFunc_Scrollbars_WM_KEYUP($hWnd, $iMsg, $wParam, $lParam)
...
; Remarks .......:
; ===============================================================================================================================
Func SpecFunc_Scrollbars_WM_ENTERSIZEMOVE($hWnd, $iMsg, $wParam, $lParam)
...
; Remarks .......:
; ===============================================================================================================================
Func SpecFunc_Scrollbars_WM_EXITSIZEMOVE($hWnd, $iMsg, $wParam, $lParam)
	...
	If $hWnd = $__g_aSB_WindowInfo[0][3] And $__g_aSB_WindowInfo[0][4] <> -1 Then
		...
		SpecFunc_GUIScrollbars_Generate($hWnd, $iH_Aperture, $iV_Aperture)
